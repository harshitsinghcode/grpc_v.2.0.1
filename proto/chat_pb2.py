...
_NOTE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='id', full_name='grpc.Note.id', index=2,
            ...
            options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='title', full_name='grpc.Note.title', index=3,
            ...
            options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='content', full_name='grpc.Note.content', index=4,
